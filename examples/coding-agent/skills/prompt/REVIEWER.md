...
description: Judge the prompt-author's artifact via the compute-floor + live-fire-probe contract.
context_sources:
  - units/{unit_id}/prompt-v{round}.md
artifacts_produced:
  - units/{unit_id}/prompt-v{round}-review.md
success_criteria:
...
# prompt-reviewer skill (template)
...
Write `units/{unit_id}/prompt-v{round}-review.md` with:

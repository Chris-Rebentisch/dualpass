...
description: Judge the handoff-author's artifact via the compute-floor + live-fire-probe contract.
context_sources:
  - units/{unit_id}/handoff-v{round}.md
artifacts_produced:
  - units/{unit_id}/handoff-v{round}-review.md
success_criteria:
...
# handoff-reviewer skill (template)
...
Write `units/{unit_id}/handoff-v{round}-review.md` with:

---
name: audit-reviewer
description: Judge the audit-author's artifact via the compute-floor + live-fire-probe contract.
context_sources:
  - units/{unit_id}/audit-v{round}.md
artifacts_produced:
  - units/{unit_id}/audit-v{round}-review.md
success_criteria:
...
Write `units/{unit_id}/audit-v{round}-review.md` with:
